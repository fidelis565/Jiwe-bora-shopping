...
<html lang="en">
	<head>
	    ...
	    <title>Jiwe Bora Construction Materials Management and Delivery</title>
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Materials</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#Roofing" data-toggle="tab">Roofing</a></li>
					<li><a href="#Structural" data-toggle="tab">Structural</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<?php } ?>
		...
		<div class="tab-pane" id="Structural">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Finishing</h3>
